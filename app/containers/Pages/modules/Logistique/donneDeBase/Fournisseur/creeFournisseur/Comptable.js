...
export default function Comptable({ data, handleChange, classes, loading }) {
  if (loading) {
    return (
      <center>
          ...
          <>
            <Grid item xs={5}>
              ...
              >
                ...
                <MenuItem value="Expert forestier,">Expert forestier,</MenuItem>
                ...
                <MenuItem value="Psychothérapeute,">Psychothérapeute,</MenuItem>
